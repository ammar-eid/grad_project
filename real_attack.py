...
def info(): #web_brute_force
    os.system("clear")
    print("#############################")
    print("# Brute_Forcing Sarting------ #")
    print("#############################")
...
def pwd_attacks():
    ...
    print("   {1}--FTP Brute-Force Attack \n")
    print("   {2}--MD5 hash cracker \n ")
    print("   {3}--ZIP file Cracker \n")
    print("   {4}--Gmail Password Cracker \n ")
    print("   {5}--HTTP brute force \n")
    print("   {6}--Press anything else to return to main menu \n ")
    choice3 = input("Enter the type of the attack")
    if choice3 == "1":
        os.system('clear')
        ftp_atk()
    elif choice3 == "2":
...
def zip_crack():
    password_list = "passs.txt"
    zip_file = input("Enter the zip file name (Must be in the same directory of the program): ")
...
def http_crack():
    ...
    url = input("Enter the login page url: ")
    username = input("Enter the username:  ")
