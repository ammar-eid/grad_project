...
def read_vul_info():
    ...
    vul_file.close()
    print(f"--> method : read_vul_info. output : {info_list} file : Nmap_scan/create_top.py")
    return info_list
...
def read_scan_config():
    ...
    with open('scan_config.csv', 'r') as csvfile:
        ...
        for i in csv_read:
            ...
            ip_list.append(i[1])
    print(f"--> method : read_scan_config. output : {host_list} and {ip_list} file : Nmap_scan/create_top.py")
    return host_list, ip_list

def deJsonTop_v1(webTemp, fileTemp):
    print(f"--> method : deJsonTop_v1. input : {webTemp} and {fileTemp} file : Nmap_scan/create_top.py")
...
def deJsonTop_v2(webTemp, fileTemp, fireTemp):
    print(f"--> method : deJsonTop_v2. input : {webTemp} and {fileTemp} and {fireTemp} file : Nmap_scan/create_top.py")
    baiscFile = open('./attack.P', 'w')
...
if __name__ == "__main__":
    ...
    count_ip = 0
    print("--> main entered file : Nmap_scan/create_top.py")
